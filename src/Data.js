...
async function userSites(db, name) {
...
async function saveArea(db, name, i, area) {
...
async function saveGroup(db, name, i, tracers, text) {
...
async function remoteData(db, name) {
...
async function sendFile(ms, ts, tracers, insights, views, db, name) {
...
function saveFile(ms, ts, tracers, insights, views) {
